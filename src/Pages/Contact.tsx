...
const sendFeedback = (e: any) => {
  ...
  return (
    <div className='text-white flex justify-center items-center w-full h-screen animate-fade-down animate-once'>
      ...
      <div className='w-full h-[40px] flex items-center flex-wrap py-2 px-3 border-[1px] border-zinc-700 rounded-md'>
        ...
        <div className='w-full h-[40px] flex items-center flex-wrap py-2 px-3 border-[1px] border-zinc-700 rounded-md'>
          <input className='outline-none sm:text-lg' type='email' name='user_email' placeholder='Company / Personal ' />
        </div>
